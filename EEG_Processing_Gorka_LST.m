...
raw_bdf_loadpath = 'C:\Users\glaze\Desktop\GorkaScripts\data\RawBDF\';
...
binlister_loadpath = 'C:\Users\glaze\Desktop\GorkaScripts\data\Binlister\LST_BinLister.txt';
...
subName = {'Subject001_LST', 'Subject002_LST','Subject003_LST'};
...
for iSubject = 1:length(subName)
    ...
    %   5c. Move FCz/Iz to channels 33-34, Move external sensors (M1/M2/VEO+/VEO-/HEOR/HEOL) to end of channel list 35-40
    % 
    % WARNING: if data channels differ you will need to edit this section to match
